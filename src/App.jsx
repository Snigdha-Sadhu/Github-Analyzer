...
localStorage.setItem("lastRepoData",JSON.stringify({
  ...
  return (
    <div className={darkmode ? ' min-w-screen min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 to-gray-800 p-6 overflow-x-visible ': "bg-white text-black min-w-screen min-h-screen flex flex-col items-center justify-center overflow-x-visible  p-6 "}>
